...
Debes **abrir, leer y analizar estos comentarios directamente desde el archivo**, y luego **escribir el código ejecutable de Pytest en ese mismo archivo**,debajo de la tabla de los casos de prueba, respetando las buenas prácticas del libro "Pragmatic Unit Testing" y la documentación oficial de Pytest.
